    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">已认定志愿服务</a>
            </div>
...
<script>
    ...
    function loadDate() {
        $.post("pages/back/volunteer_confirm_list.action",{},function (obj) {
            $("#volunteerTable tr:gt(0)").remove();
            for (var x = 0;x <obj.allVolunteer.length;x++){
                addRow(obj.allVolunteer[x].st_number,obj.allVolunteer[x].st_name,obj.allVolunteer[x].date,obj.allVolunteer[x].name,obj.allVolunteer[x].score);
            }
        },"json");
    }

    function addRow(st_number,st_name,date,name,score) {
        var str = "<tr>" +
            "<td>"+st_number+"</td>"+
            "<td>"+st_name+"</td>"+
            "<td>"+name+"</td>"+
            "<td>"+date+"</td>"+
            "<td>"+score+"</td>"+
            "<td><a class='btn btn-danger btn-sm' href='pages/back/volunteer_confirm_delete.action?st_number=" +
            st_number + "'>删除</a></td>" +
            "</tr>";
