    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <form class="navbar-form navbar-left" action="/pages/back/student_search.action">
    ...
    function loadDate() {
        $.post("pages/back/student_list.action",{},function (obj) {
            ...
            for (var x = 0;x <obj.allStudent.length;x++){
                addRow(obj.allStudent[x].st_name,obj.allStudent[x].st_number,obj.allStudent[x].st_lastdate);
            }
        },"json");
    }
