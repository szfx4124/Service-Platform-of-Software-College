    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">发布公告</a>
            </div>
        </div><!-- /.container-fluid -->
        <div class="container">
            <form action="<%=basePath%>pages/back/board_insert.action" method="post" class="form-horizontal" enctype="multipart/form-data" id="insertArticle">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="name" id="name" value="<%=request.getSession().getAttribute("ad_name")%>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="content" class="control-label col-md-3">内容</label>
                    <div class="col-md-5">
                        <textarea class="form-control" rows="3" name="content" id="content" placeholder="请输入内容"></textarea>
                    </div>
                </div>
                <div class="form-group">
