    ...
    <nav class="navbar navbar-default">
        ...
        <div class="form-group">
            <div class="tools col-md-9">
                <button type="button" class="btn btn-success" id="excell"  onclick="method5('boardTable')">导出信息表</button>
            </div>
            <div class="col-md-3">
...
<script>
    ...
    function addRow(title,name,content,date) {
        var str = "<tr>" +
            ...
            "<td>"+content+"</td>"+
            "<td>"+date+"</td>"+
            "<td><a class='btn btn-danger btn-sm' href='pages/back/board_delete.action?title=" +
            title + "'>删除</a></td>" +
            "</tr>";
