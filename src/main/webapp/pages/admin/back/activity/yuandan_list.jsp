    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">软件学院2019年元旦晚会</a>
            </div>
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-hover" id="yuandanTable">
                <tr>
                    <th>领队学号</th>
                    <th>领队姓名</th>
                    <th>节目名称</th>
        ...
        <div class="form-group">
            <div class="tools col-md-9">
                <button type="button" class="btn btn-success" id="excell"  onclick="method5('yuandanTable')">导出信息表</button>
            </div>
            <div class="col-md-3">
...
<%--<script src="jquery/activity/yuandan_list.js"></script>--%>
<script>
    $(function () {
        loadDate();
    })
